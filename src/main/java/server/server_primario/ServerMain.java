    ...
    public static void main(String[] args) {
        try {
            ...
            // REINICIAR SERVIDOR PRIMARIO
                ...
                String ipMonitor = "localhost";
                String puertoMonitor = "3000";
                ...
                if (opcion.equals("1")) {
                    ...
                    // Conexion con monitor
                    System.out.println("Ingrese IP del monitor: ");
                    ipMonitor = sc.nextLine();
                    System.out.println("Ingrese puerto del monitor: ");
                    puertoMonitor = sc.nextLine();
                }
                Heartbeat.getInstance().setIp(ipMonitor);
                Heartbeat.getInstance().setPuerto(Integer.parseInt(puertoMonitor));
                Heartbeat.getInstance().start();
